...
test('Move 119 Org profile CONTROL v0.2.57 backlink verifier exits cleanly', () => {
  const out = execFileSync('node', ["scripts/verify-org-profile-move119-control-v0257-backlink.mjs"], { encoding: 'utf8' });
