...
const receipt = JSON.parse(readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE69_CONTROL_V0232_BACKLINK.json', 'utf8'));
...
assert.equal(receipt.surface_version, '0.0.41');
assert.equal(receipt.surface_tag, 'v0.0.41-antimatterium-org-profile-control-v0232-backlink');
assert.equal(receipt.surface_release, 'https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.41-antimatterium-org-profile-control-v0232-backlink');
...
assert.equal(receipt.backlink_id, '0bd3fcadae438a38c32aa9bcb06dfbb3ce8a37e85ee13b3ad15f831d4d5cccb9');

console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE69_CONTROL_V0232_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0232_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0232_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE69_CONTROL_V0232_BACKLINK_ID=0bd3fcadae438a38c32aa9bcb06dfbb3ce8a37e85ee13b3ad15f831d4d5cccb9');
