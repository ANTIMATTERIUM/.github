...
const receiptPath = "public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE119_CONTROL_V0257_BACKLINK.json";
...
const stable = {
  ...
  "move": 119,
  "surface": "ORG_PROFILE",
  "surface_label": "Org profile",
  "surface_repo": "ANTIMATTERIUM/.github",
  "surface_version": "0.0.66",
  "surface_tag": "v0.0.66-antimatterium-org-profile-control-v0257-backlink",
...
assert(receipt.surface === "ORG_PROFILE", 'MOVE119_RECEIPT_SURFACE_MISMATCH');
assert(receipt.surface_version === "0.0.66", 'MOVE119_RECEIPT_VERSION_MISMATCH');
assert(receipt.surface_tag === "v0.0.66-antimatterium-org-profile-control-v0257-backlink", 'MOVE119_RECEIPT_TAG_MISMATCH');
...
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE119_CONTROL_V0257_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE119_CONTROL_V0257_BACKLINK_CONTROL_V0257_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE119_CONTROL_V0257_BACKLINK_CONTROL_V0257_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE119_CONTROL_V0257_BACKLINK_ID=' + receipt.backlink_id);
