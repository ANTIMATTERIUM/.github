...
const receipt = JSON.parse(
  fs.readFileSync("public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE143_CONTROL_V0269_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "packageTag": "v0.0.78-antimatterium-org-profile-control-v0269-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.78-antimatterium-org-profile-control-v0269-backlink",
  ...
  "backlinkId": "7422db968eac4d1dda7cea72a3985581ef28aa8ece97c66f0cf5306183a66b1e"
};
const outputPrefix = "ANTIMATTERIUM_ORG_PROFILE_MOVE143_CONTROL_V0269_BACKLINK";
