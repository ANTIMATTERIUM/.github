...
const receipt = JSON.parse(
  fs.readFileSync("public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE123_CONTROL_V0259_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "packageTag": "v0.0.68-antimatterium-org-profile-control-v0259-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.68-antimatterium-org-profile-control-v0259-backlink",
  ...
  "backlinkId": "d4f1cdfced5fe1479d6b4f2731ea32667050de312a863a899056097bcf8f9f7d"
};
const outputPrefix = "ANTIMATTERIUM_ORG_PROFILE_MOVE123_CONTROL_V0259_BACKLINK";
