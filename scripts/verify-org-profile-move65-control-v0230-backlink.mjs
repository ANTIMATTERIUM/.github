...
test("Org profile binds CONTROL v0.2.30 public closure", () => {
  ...
  assert.equal(receipt.surface_public_tag, "v0.0.39-antimatterium-org-profile-control-v0230-backlink");
  ...
  assert.equal(backlink_id, "d71a04c6391e04b0674d3cdc78955255611b11ee85ebdf8bc34ef1b4b712adf3");
  assert.equal(canonicalHash(payload), "d71a04c6391e04b0674d3cdc78955255611b11ee85ebdf8bc34ef1b4b712adf3");
  console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE65_CONTROL_V0230_BACKLINK_VERIFY_PASS=true");
  console.log("ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0230_RELEASE_BOUND=true");
  console.log("ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0230_MEMBER=true");
  console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
  console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
  console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE65_CONTROL_V0230_BACKLINK_ID=" + backlink_id);
