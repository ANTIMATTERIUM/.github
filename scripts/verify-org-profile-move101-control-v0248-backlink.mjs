...
const receiptPath = "public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE101_CONTROL_V0248_BACKLINK.json";
const expected = {
  "protocol": "ANTIMATTERIUM_ORG_PROFILE_MOVE101_CONTROL_V0248_BACKLINK",
  "move": 101,
  "surface": {
    "name": "Org profile",
    ...
    "version": "0.0.57",
    "receipt_path": "public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE101_CONTROL_V0248_BACKLINK.json",
    "verifier": "scripts/verify-org-profile-move101-control-v0248-backlink.mjs",
    "test": "tests/org-profile-move101-control-v0248-backlink.test.mjs"
  },
  "source_control": {
  ...
  "backlinkId": "29e68dcf4d7f831822f5313b6d5b3aebd803dd00b90563b06006363928db4187"
};
...
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE101_CONTROL_V0248_BACKLINK_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE101_CONTROL_V0248_BACKLINK_CONTROL_V0248_RELEASE_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE101_CONTROL_V0248_BACKLINK_CONTROL_V0248_MEMBER=true");
console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE101_CONTROL_V0248_BACKLINK_ID=" + backlink.id);
