...
const receipt = JSON.parse(readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE83_CONTROL_V0239_BACKLINK.json', 'utf8'));
...
assert.equal(receipt.version, '0.0.48');
assert.equal(receipt.branch, 'antimatterium-org-profile-v0048-control-v0239-backlink');
assert.equal(receipt.tag, 'v0.0.48-antimatterium-org-profile-control-v0239-backlink');
assert.equal(receipt.release, 'https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.48-antimatterium-org-profile-control-v0239-backlink');
...
assert.equal(receipt.backlink_id, '07389863553ef6f06301e7ccbc5678c265067f59a0d5b40cd0d956a42f47e444');

console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE83_CONTROL_V0239_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0239_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0239_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE83_CONTROL_V0239_BACKLINK_ID=07389863553ef6f06301e7ccbc5678c265067f59a0d5b40cd0d956a42f47e444');
