...
const receipt = JSON.parse(readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE71_CONTROL_V0233_BACKLINK.json', 'utf8'));
...
assert.equal(receipt.surface_version, '0.0.42');
assert.equal(receipt.surface_tag, 'v0.0.42-antimatterium-org-profile-control-v0233-backlink');
assert.equal(receipt.surface_release, 'https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.42-antimatterium-org-profile-control-v0233-backlink');
...
assert.equal(receipt.backlink_id, 'da69ca9e87525e415cf2f48eebfc35bda2d480669bce7aaa18006581836d5e01');

console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE71_CONTROL_V0233_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0233_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0233_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE71_CONTROL_V0233_BACKLINK_ID=da69ca9e87525e415cf2f48eebfc35bda2d480669bce7aaa18006581836d5e01');
