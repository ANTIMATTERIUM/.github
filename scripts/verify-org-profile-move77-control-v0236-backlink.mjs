...
const receipt = JSON.parse(readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE77_CONTROL_V0236_BACKLINK.json', 'utf8'));
...
assert.equal(receipt.surface_version, '0.0.45');
assert.equal(receipt.surface_tag, 'v0.0.45-antimatterium-org-profile-control-v0236-backlink');
...
assert.equal(receipt.backlink_id, '39d0be009618a6e0536780345b806fa1feb49c1d578048534fda26ba17693c89');

console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE77_CONTROL_V0236_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0236_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0236_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE77_CONTROL_V0236_BACKLINK_ID=39d0be009618a6e0536780345b806fa1feb49c1d578048534fda26ba17693c89');
