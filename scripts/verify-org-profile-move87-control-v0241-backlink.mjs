...
const receipt = JSON.parse(fs.readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE87_CONTROL_V0241_BACKLINK.json', 'utf8'));

assert.equal(receipt.schema, 'antimatterium.org_profile.move87.control_v0241_backlink.v1');
...
assert.equal(receipt.version, '0.0.50');
...
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE87_CONTROL_V0241_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE87_CONTROL_V0241_BACKLINK_CONTROL_V0241_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE87_CONTROL_V0241_BACKLINK_CONTROL_V0241_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE87_CONTROL_V0241_BACKLINK_ID=' + receipt.backlink_id);
