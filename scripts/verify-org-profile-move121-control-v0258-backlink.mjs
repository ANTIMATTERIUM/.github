...
const receiptPath = "public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE121_CONTROL_V0258_BACKLINK.json";
...
const expected = {
  ...
  prefix: "ORG_PROFILE",
  label: "Org profile",
  repo: "ANTIMATTERIUM/.github",
  package: "@antimatterium/org-profile",
  version: "0.0.67",
  tag: "v0.0.67-antimatterium-org-profile-control-v0258-backlink",
  release: "https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.67-antimatterium-org-profile-control-v0258-backlink",
  ...
  backlink_id: "b9bc695553018439f5c97941d047ae155e5113de4a3de1e3386bdfde99d02bd1"
};
...
for (const [name, actual, exp] of checks) {
  if (actual !== exp) fail(`MOVE121_ORG_PROFILE_CHECK_FAILED ${name}: expected ${exp}, got ${actual}`);
}
...
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE121_CONTROL_V0258_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE121_CONTROL_V0258_BACKLINK_CONTROL_V0258_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE121_CONTROL_V0258_BACKLINK_CONTROL_V0258_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE121_CONTROL_V0258_BACKLINK_ID=' + receipt.backlink_id);
