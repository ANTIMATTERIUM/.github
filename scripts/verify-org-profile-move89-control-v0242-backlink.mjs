...
const receipt = JSON.parse(fs.readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE89_CONTROL_V0242_BACKLINK.json', 'utf8'));

assert.equal(receipt.schema, 'antimatterium.org_profile.move89.control_v0242_backlink.v1');
...
assert.equal(receipt.version, '0.0.51');
...
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE89_CONTROL_V0242_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE89_CONTROL_V0242_BACKLINK_CONTROL_V0242_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE89_CONTROL_V0242_BACKLINK_CONTROL_V0242_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE89_CONTROL_V0242_BACKLINK_ID=' + receipt.backlink_id);
