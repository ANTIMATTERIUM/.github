...
const receipt = JSON.parse(fs.readFileSync("public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE115_CONTROL_V0255_BACKLINK.json", "utf8"));

assert.equal(receipt.protocol, "ANTIMATTERIUM_ORG_PROFILE_MOVE115_CONTROL_V0255_BACKLINK");
...
assert.equal(receipt.surface.version, "0.0.64");
assert.equal(receipt.surface.release_tag, "v0.0.64-antimatterium-org-profile-control-v0255-backlink");
assert.equal(receipt.surface.release, "https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.64-antimatterium-org-profile-control-v0255-backlink");
...
assert.equal(backlink_id, "10252b4d19d3477e3ff415f43a942ec764c78d1da0775f643e55327d0b46ec52");
...
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE115_CONTROL_V0255_BACKLINK_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE115_CONTROL_V0255_BACKLINK_CONTROL_V0255_RELEASE_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE115_CONTROL_V0255_BACKLINK_CONTROL_V0255_MEMBER=true");
console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE115_CONTROL_V0255_BACKLINK_ID=" + backlink_id);
