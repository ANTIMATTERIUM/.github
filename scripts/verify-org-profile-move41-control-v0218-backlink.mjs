...
const receipt = JSON.parse(fs.readFileSync(new URL('../public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE41_CONTROL_V0218_BACKLINK.json', import.meta.url), 'utf8'));
const pkg = JSON.parse(fs.readFileSync(new URL('../package.json', import.meta.url), 'utf8'));

test('Org profile binds CONTROL v0.2.18 public closure', () => {
  ...
  assert.equal(receipt.package_version, '0.0.27');
  ...
  assert.equal(receipt.backlink_id, '2ea777fdfe235d31159ec4601a1c26098d0a0ec2092319fd171ac332863ee008');
  assert.equal(receipt.ORG_PROFILE_MOVE41_CONTROL_V0218_BACKLINK_ID, '2ea777fdfe235d31159ec4601a1c26098d0a0ec2092319fd171ac332863ee008');

  console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE41_CONTROL_V0218_BACKLINK_VERIFY_PASS=true');
  console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0218_RELEASE_BOUND=true');
  console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0218_MEMBER=true');
  console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
  console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
  console.log('ORG_PROFILE_MOVE41_CONTROL_V0218_BACKLINK_ID=2ea777fdfe235d31159ec4601a1c26098d0a0ec2092319fd171ac332863ee008');
