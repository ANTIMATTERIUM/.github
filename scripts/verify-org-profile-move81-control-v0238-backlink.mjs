...
const receipt = JSON.parse(readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE81_CONTROL_V0238_BACKLINK.json', 'utf8'));
...
assert.equal(receipt.surface_version, '0.0.47');
assert.equal(receipt.surface_tag, 'v0.0.47-antimatterium-org-profile-control-v0238-backlink');
...
assert.equal(receipt.backlink_id, '34cefba9a61620139341114138f03b0238ac973a770626f3b13cc1ee9f0e5091');

console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE81_CONTROL_V0238_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0238_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0238_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE81_CONTROL_V0238_BACKLINK_ID=34cefba9a61620139341114138f03b0238ac973a770626f3b13cc1ee9f0e5091');
