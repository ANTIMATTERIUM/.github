...
const receipt = JSON.parse(
  fs.readFileSync("public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE131_CONTROL_V0263_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "packageTag": "v0.0.72-antimatterium-org-profile-control-v0263-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.72-antimatterium-org-profile-control-v0263-backlink",
  ...
  "backlinkId": "d72b8f06bb92dc6232a36cdbe063f3d5e30d714484bb199c86f6a592ed5f136b"
};
const outputPrefix = "ANTIMATTERIUM_ORG_PROFILE_MOVE131_CONTROL_V0263_BACKLINK";
