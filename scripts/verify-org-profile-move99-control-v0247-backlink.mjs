...
const receiptPath = "public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE99_CONTROL_V0247_BACKLINK.json";
const expected = {
  "protocol": "ANTIMATTERIUM_ORG_PROFILE_MOVE99_CONTROL_V0247_BACKLINK",
  "move": 99,
  "surface": {
    "label": "Org profile",
    ...
    "receipt_path": "public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE99_CONTROL_V0247_BACKLINK.json",
    "verifier": "scripts/verify-org-profile-move99-control-v0247-backlink.mjs",
    "test": "tests/org-profile-move99-control-v0247-backlink.test.mjs"
  },
  "control": {
  ...
  "backlinkKind": "move99_org_profile_control_v0247_backlink",
  "backlinkId": "3aa39959e3a7b7e4d53ba8eae3d164d22532de1a892e8a5d28705476170d61b1"
};
...
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE99_CONTROL_V0247_BACKLINK_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE99_CONTROL_V0247_BACKLINK_CONTROL_V0247_RELEASE_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE99_CONTROL_V0247_BACKLINK_CONTROL_V0247_MEMBER=true");
console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE99_CONTROL_V0247_BACKLINK_ID=" + backlink.id);
