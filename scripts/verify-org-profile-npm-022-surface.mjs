...
assert(receipt.schema === "ANTIMATTERIUM_ORG_PROFILE_NPM_022_PUBLICATION_SURFACE", "profile schema mismatch");
assert(receipt.object === "ANTIMATTERIUM_ORG_PROFILE", "profile object mismatch");
assert(receipt.org_profile_version === "0.0.4", "profile version mismatch");

assert(receipt.public_surfaces.org === "https://github.com/ANTIMATTERIUM", "org mismatch");
assert(receipt.public_surfaces.www_site === "https://antimatterium.github.io/WWW/", "www site mismatch");
...
assert(receipt.release_chain.core_v0210 === "https://github.com/ANTIMATTERIUM/ANTIMATTERIUM/releases/tag/v0.2.10-antimatterium-npm-022-publication", "core v0.2.10 mismatch");
assert(receipt.release_chain.www_v016 === "https://github.com/ANTIMATTERIUM/WWW/releases/tag/v0.1.6-antimatterium-www-npm-022-publication-surface", "www v0.1.6 mismatch");

assert(receipt.bound_identifiers.www_surface_receipt_id === "652a71c7a591d9c99e5781d154f5d3ff7fd5a78ed6d4529e220f50c902adf321", "www surface receipt mismatch");
...
assert(text.includes("npx antimatterium-public-external-verify"), "external verifier command missing");
...
console.log("ANTIMATTERIUM_ORG_PROFILE_NPM_022_SURFACE_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_CORE_V0210_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_WWW_V016_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_NPM_022_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_WWW_SURFACE_RECEIPT_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_NPM_RECEIPT_ID_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_EXTERNAL_PUBLIC_VERIFIER_BOUND=true");
