...
const receiptPath = "public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE109_CONTROL_V0252_BACKLINK.json";
const receipt = JSON.parse(fs.readFileSync(receiptPath, "utf8"));

assert.equal(receipt.protocol, "ANTIMATTERIUM_ORG_PROFILE_MOVE109_CONTROL_V0252_BACKLINK");
...
assert.equal(receipt.surface.repo, "ANTIMATTERIUM/.github");
assert.equal(receipt.surface.version, "0.0.61");
assert.equal(receipt.surface.release_tag, "v0.0.61-antimatterium-org-profile-control-v0252-backlink");
...
assert.equal(backlink.id, "7e13161fecd4f3f64332e96aa1efd73704d5b4fdfb85b5f2083837b65da180ad");
...
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE109_CONTROL_V0252_BACKLINK_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE109_CONTROL_V0252_BACKLINK_CONTROL_V0252_RELEASE_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE109_CONTROL_V0252_BACKLINK_CONTROL_V0252_MEMBER=true");
console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE109_CONTROL_V0252_BACKLINK_ID=" + backlink.id);
