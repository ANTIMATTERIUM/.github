...
const receipt = JSON.parse(fs.readFileSync('public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE91_CONTROL_V0243_BACKLINK.json', 'utf8'));

assert.equal(receipt.schema, 'antimatterium.org_profile.move91.control_v0243_backlink.v1');
...
assert.equal(receipt.version, '0.0.52');
...
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE91_CONTROL_V0243_BACKLINK_VERIFY_PASS=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE91_CONTROL_V0243_BACKLINK_CONTROL_V0243_RELEASE_BOUND=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE91_CONTROL_V0243_BACKLINK_CONTROL_V0243_MEMBER=true');
console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
console.log('ANTIMATTERIUM_ORG_PROFILE_MOVE91_CONTROL_V0243_BACKLINK_ID=' + receipt.backlink.id);
