...
const receipt = JSON.parse(fs.readFileSync("public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE97_CONTROL_V0246_BACKLINK.json", "utf8"));
...
assert.equal(receipt.schema, "antimatterium.org_profile.move97.control_v0246_backlink.v1");
...
assert.equal(receipt.surface.version, "0.0.55");
assert.equal(receipt.surface.release_tag, "v0.0.55-antimatterium-org-profile-control-v0246-backlink");
...
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE97_CONTROL_V0246_BACKLINK_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE97_CONTROL_V0246_BACKLINK_CONTROL_V0246_RELEASE_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE97_CONTROL_V0246_BACKLINK_CONTROL_V0246_MEMBER=true");
console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE97_CONTROL_V0246_BACKLINK_ID=" + backlink.id);
