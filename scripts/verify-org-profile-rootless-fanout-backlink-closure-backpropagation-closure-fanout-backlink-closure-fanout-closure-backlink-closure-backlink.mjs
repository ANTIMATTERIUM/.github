...
const receipt = JSON.parse(fs.readFileSync(new URL("../public/receipts/ANTIMATTERIUM_ORG_PROFILE_ROOTLESS_FANOUT_BACKLINK_CLOSURE_BACKPROPAGATION_CLOSURE_FANOUT_BACKLINK_CLOSURE_FANOUT_CLOSURE_BACKLINK_CLOSURE_BACKLINK.json", import.meta.url), "utf8"));
const pkg = JSON.parse(fs.readFileSync(new URL("../package.json", import.meta.url), "utf8"));

assert(pkg.version === "0.0.19", "package version mismatch");
assert(receipt.package.version === "0.0.19", "receipt package version mismatch");
...
console.log("ORG_PROFILE3" + "_VERIFY_PASS=true");
console.log("ORG_PROFILE3" + "_CONTROL_V0210_RELEASE_BOUND=true");
console.log("ORG_PROFILE3" + "_CONTROL_V0210_MEMBER=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("ORG_PROFILE4" + "=" + receipt.closure_id);
