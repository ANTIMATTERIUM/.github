...
const receipt = JSON.parse(
  fs.readFileSync("public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE129_CONTROL_V0262_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "packageTag": "v0.0.71-antimatterium-org-profile-control-v0262-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/.github/releases/tag/v0.0.71-antimatterium-org-profile-control-v0262-backlink",
  ...
  "backlinkId": "cb7c72f27964e0a105c0433f803a4422e5b966f55b5ad716679b94757d4b1637"
};
const outputPrefix = "ANTIMATTERIUM_ORG_PROFILE_MOVE129_CONTROL_V0262_BACKLINK";
