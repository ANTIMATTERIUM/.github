...
const receiptPath = path.resolve(__dirname, "../public/receipts/ANTIMATTERIUM_ORG_PROFILE_MOVE117_CONTROL_V0256_BACKLINK.json");
...
assert.equal(receipt.protocol, "ANTIMATTERIUM_ORG_PROFILE_MOVE117_CONTROL_V0256_BACKLINK");
assert.equal(receipt.move, 117);
assert.equal(receipt.repository, "ANTIMATTERIUM/.github");
assert.equal(receipt.surfaceVersion, "0.0.65");
assert.equal(receipt.surfaceTag, "v0.0.65-antimatterium-org-profile-control-v0256-backlink");
...
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE117_CONTROL_V0256_BACKLINK_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE117_CONTROL_V0256_BACKLINK_CONTROL_V0256_RELEASE_BOUND=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE117_CONTROL_V0256_BACKLINK_CONTROL_V0256_MEMBER=true");
console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE117_CONTROL_V0256_BACKLINK_ID=" + backlinkId);
