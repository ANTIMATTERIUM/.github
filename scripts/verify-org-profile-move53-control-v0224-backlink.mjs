...
const expected = {
  ...
  surfacePublicTag: "v0.0.33-antimatterium-org-profile-control-v0224-backlink",
  backlinkId: "e587609ef1185666dd0074a06f877582ab7df86cd2a4daa3444184b4e647ed91"
};
...
test("Org profile binds CONTROL v0.2.24 public closure", () => {
  ...
  console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE53_CONTROL_V0224_BACKLINK_VERIFY_PASS=true");
  console.log("ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0224_RELEASE_BOUND=true");
  console.log("ANTIMATTERIUM_ORG_PROFILE_CONTROL_V0224_MEMBER=true");
  console.log("ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true");
  console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
  console.log("ANTIMATTERIUM_ORG_PROFILE_MOVE53_CONTROL_V0224_BACKLINK_ID=" + backlink_id);
